...
def normalise_application_log_hours(hours: float) -> float:
    if hours >= 160:
        return 100.0
    elif hours >= 140:
        return 80.0
...
def compute_application_functional_score(
    log_hours: float,
    sentiment_score: float,
) -> float:
    log_hours_score = normalise_application_log_hours(log_hours)
...
def compute_application_final_score(
