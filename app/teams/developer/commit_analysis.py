"""
app/teams/developer/commit_analysis.py
──────────────────────────────────────
LangGraph workflow for analysing developer commits.

This module is developer-specific (it scores code-quality for commits)
and therefore lives in the developer team package, not in
``app/shared/``.
...
from app.shared.data_sources.commit_gitlab_client import (
